-- [1] Creating table restaurant with columns and primary key
...
-- [2] Creating table address with columns and primary key
...
-- [4] Creating a category table with promary key
...
-- [5] creating a table dish with primary key
CREATE TABLE dish (
  id integer PRIMARY KEY,
  name varchar(50),
  description varchar(200),
...
-- [6] creating a table review with primary key
CREATE TABLE review (
  id integer PRIMARY KEY,
  rating decimal,
  description varchar(200),
